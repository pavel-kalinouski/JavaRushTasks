...
public class Solution {
    ...
    public static Map<String, String> createPeopleMap() {
        ...
        map.put("Данцевич","Иван");
        map.put("Киселев","Женя");
        map.put("Кищенко","Максим");
        map.put("Зарецкий","Иванн");
        map.put("Жойдь","Павел");
        map.put("Новицкий","Андрей");
        map.put("Михальчук","Ольга");
        map.put("Калиновская","Галина");
        map.put("Калиновский","Семёе");
